...
namespace Yandex.Music.Api.Requests.Artist
{
    ...
    public class YGetArtistDirectAlbumsBuilder: YRequestBuilder<YResponse<YAlbumsPage>, (string id, int page, int pageSize)>
    {
        public YGetArtistDirectAlbumsBuilder(YandexMusicApi yandex, AuthStorage auth) : base(yandex, auth) { }
